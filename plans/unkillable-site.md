...
**PRD:** https://github.com/stillmusic-tech/unkillable/issues/1 (vault twin: `PRDs/Unkillable/Unkillable — Site PRD.md`)  ·  **Status:** Phases 1–14 COMPLETE. All seven attacks playable; report card + share done (built onto the quantum page, the site finale per the register). Phase 15 (fundamentals ladder + mid-attack overlay) done. Remaining: 16 (about + sourcing sweep), 17 (touch pass), then deploy + the merged HITL feel review.
