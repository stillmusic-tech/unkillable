// The eight Bitcoin Fundamentals cards, in the locked person-driven order
// (the book → its pages → its keepers → its writers → why it's safe → its money
// rule → your ownership → the real world). One idea, one visual, zero prior
// knowledge each. Shared by the Fundamentals landing page and the mid-attack
// overlay so the content lives in exactly one place.
...
export const CARDS: FundCard[] = [
  ...
  },
  {
    id: 'mining',
    icon: '⛏️',
    title: 'What does mining actually do?',
  ...
  },
  {
    id: 'energy',
    icon: '⚡',
    title: 'Why does burning energy protect anything?',
  ...
  },
  {
    id: 'companies',
    icon: '🏦',
    title: 'Bitcoin vs the companies around it',
    idea: 'Most people touch Bitcoin through apps and exchanges — ordinary companies that can be hacked, seized or go bust. When one fails, headlines say "Bitcoin" — but the network underneath never missed a beat. The vault has never been picked; people get robbed in the car park. Holding your own key is stepping out of the car park.',
    visual:
      '<div class="viz-row"><span>🏦💥</span><span>vs</span><span>🌐✅</span></div><p class="viz-cap">a company failing is not the network failing</p>',
    attackHref: '/attack/hack',
    attackLabel: 'See the vault vs the car park →',
  },
]
